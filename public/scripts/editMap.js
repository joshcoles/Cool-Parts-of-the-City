...
// parse the map data and draw map.
function editMap(){
...
function drawMap (data) {
  ...
  // render map that is to be edited.
  map = new google.maps.Map(document.getElementById('map'), mapOptions);

  // render points on that map.
  ...
  // assign map on click listener with new marker on click
  map.addListener('click', function(e) {
    let thisMarker = marker(e.latLng.lat(), e.latLng.lng(), map);
    markerArr.push(thisMarker);
  });

  // place auto complete search bar on top of map.
